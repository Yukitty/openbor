...
#define LIST_ADD(y,z) List_InsertAfter(result, (void*) y, z)
    ...
    LIST_ADD(CMD_LEVEL_5PHEALTH, "5phealth");
    LIST_ADD(CMD_LEVEL_5PITEM, "5pitem");
    LIST_ADD(CMD_LEVEL_5PSPAWN, "5pspawn");
    LIST_ADD(CMD_LEVEL_6PHEALTH, "6phealth");
    LIST_ADD(CMD_LEVEL_6PITEM, "6pitem");
    LIST_ADD(CMD_LEVEL_6PSPAWN, "6pspawn");
    ...
    LIST_ADD(CMD_LEVEL_SPAWN5, "spawn5");
    LIST_ADD(CMD_LEVEL_SPAWN6, "spawn6");
...
#define LIST_ADD(y,z) List_InsertAfter(result, (void*) y, z)
    ...
    LIST_ADD(CMD_LEVELORDER_E5ICON, "e5icon");
    LIST_ADD(CMD_LEVELORDER_E5LIFE, "e5life");
    LIST_ADD(CMD_LEVELORDER_E5NAME, "e5name");
    LIST_ADD(CMD_LEVELORDER_E6ICON, "e6icon");
    LIST_ADD(CMD_LEVELORDER_E6LIFE, "e6life");
    LIST_ADD(CMD_LEVELORDER_E6NAME, "e6name");
    ...
    LIST_ADD(CMD_LEVELORDER_MP5ICON, "mp5icon");
    LIST_ADD(CMD_LEVELORDER_MP6ICON, "mp6icon");
    ...
    LIST_ADD(CMD_LEVELORDER_P5ICON, "p5icon");
    LIST_ADD(CMD_LEVELORDER_P5ICONW, "p5iconw");
    LIST_ADD(CMD_LEVELORDER_P5LIFE, "p5life");
    LIST_ADD(CMD_LEVELORDER_P5LIFEN, "p5lifen");
    LIST_ADD(CMD_LEVELORDER_P5LIFEX, "p5lifex");
    LIST_ADD(CMD_LEVELORDER_P5MP, "p5mp");
    LIST_ADD(CMD_LEVELORDER_P5NAMEJ, "p5namej");
    LIST_ADD(CMD_LEVELORDER_P5RUSH, "p5rush");
    LIST_ADD(CMD_LEVELORDER_P5SCORE, "p5score");
    LIST_ADD(CMD_LEVELORDER_P5SHOOT, "p5shoot");
    LIST_ADD(CMD_LEVELORDER_P5SMENU, "p5smenu");
    LIST_ADD(CMD_LEVELORDER_P6ICON, "p6icon");
    LIST_ADD(CMD_LEVELORDER_P6ICONW, "p6iconw");
    LIST_ADD(CMD_LEVELORDER_P6LIFE, "p6life");
    LIST_ADD(CMD_LEVELORDER_P6LIFEN, "p6lifen");
    LIST_ADD(CMD_LEVELORDER_P6LIFEX, "p6lifex");
    LIST_ADD(CMD_LEVELORDER_P6MP, "p6mp");
    LIST_ADD(CMD_LEVELORDER_P6NAMEJ, "p6namej");
    LIST_ADD(CMD_LEVELORDER_P6RUSH, "p6rush");
    LIST_ADD(CMD_LEVELORDER_P6SCORE, "p6score");
    LIST_ADD(CMD_LEVELORDER_P6SHOOT, "p6shoot");
    LIST_ADD(CMD_LEVELORDER_P6SMENU, "p6smenu");
