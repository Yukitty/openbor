...
#define	CONTROL_DEFAULT5_UP			(1+(18*4))
#define	CONTROL_DEFAULT5_RIGHT		(2+(18*4))
#define	CONTROL_DEFAULT5_DOWN		(3+(18*4))
#define	CONTROL_DEFAULT5_LEFT		(4+(18*4))
#define CONTROL_DEFAULT5_FIRE1		(7+(18*4))
#define CONTROL_DEFAULT5_FIRE2		(6+(18*4))
#define	CONTROL_DEFAULT5_FIRE3		(9+(18*4))
#define	CONTROL_DEFAULT5_FIRE4		(10+(18*4))
#define	CONTROL_DEFAULT5_FIRE5		(5+(18*4))
#define	CONTROL_DEFAULT5_FIRE6		(8+(18*4))
#define CONTROL_DEFAULT5_START		(11+(18*4))
#define CONTROL_DEFAULT5_SCREENSHOT (12+(18*4))

#define	CONTROL_DEFAULT6_UP			(1+(18*5))
#define	CONTROL_DEFAULT6_RIGHT		(2+(18*5))
#define	CONTROL_DEFAULT6_DOWN		(3+(18*5))
#define	CONTROL_DEFAULT6_LEFT		(4+(18*5))
#define CONTROL_DEFAULT6_FIRE1		(7+(18*5))
#define CONTROL_DEFAULT6_FIRE2		(6+(18*5))
#define	CONTROL_DEFAULT6_FIRE3		(9+(18*5))
#define	CONTROL_DEFAULT6_FIRE4		(10+(18*5))
#define	CONTROL_DEFAULT6_FIRE5		(5+(18*5))
#define	CONTROL_DEFAULT6_FIRE6		(8+(18*5))
#define CONTROL_DEFAULT6_START		(11+(18*5))
#define CONTROL_DEFAULT6_SCREENSHOT (12+(18*5))
