...
#define	CONTROL_DEFAULT5_UP			((JOY_LIST_FIRST + 1) + (JOY_MAX_INPUTS * 4))
#define	CONTROL_DEFAULT5_RIGHT		((JOY_LIST_FIRST + 2) + (JOY_MAX_INPUTS * 4))
#define	CONTROL_DEFAULT5_DOWN		((JOY_LIST_FIRST + 3) + (JOY_MAX_INPUTS * 4))
#define	CONTROL_DEFAULT5_LEFT		((JOY_LIST_FIRST + 4) + (JOY_MAX_INPUTS * 4))
#define CONTROL_DEFAULT5_FIRE1		((JOY_LIST_FIRST + 5) + (JOY_MAX_INPUTS * 4))
#define CONTROL_DEFAULT5_FIRE2		((JOY_LIST_FIRST + 6) + (JOY_MAX_INPUTS * 4))
#define	CONTROL_DEFAULT5_FIRE3		((JOY_LIST_FIRST + 7) + (JOY_MAX_INPUTS * 4))
#define	CONTROL_DEFAULT5_FIRE4		((JOY_LIST_FIRST + 8) + (JOY_MAX_INPUTS * 4))
#define	CONTROL_DEFAULT5_FIRE5		((JOY_LIST_FIRST + 9) + (JOY_MAX_INPUTS * 4))
#define	CONTROL_DEFAULT5_FIRE6		((JOY_LIST_FIRST + 10) + (JOY_MAX_INPUTS * 4))
#define CONTROL_DEFAULT5_START		((JOY_LIST_FIRST + 11) + (JOY_MAX_INPUTS * 4))
#define CONTROL_DEFAULT5_SCREENSHOT ((JOY_LIST_FIRST + 12) + (JOY_MAX_INPUTS * 4))
#define	CONTROL_DEFAULT5_ESC        ((JOY_LIST_FIRST + 15) + (JOY_MAX_INPUTS * 4))

#define	CONTROL_DEFAULT6_UP			((JOY_LIST_FIRST + 1) + (JOY_MAX_INPUTS * 5))
#define	CONTROL_DEFAULT6_RIGHT		((JOY_LIST_FIRST + 2) + (JOY_MAX_INPUTS * 5))
#define	CONTROL_DEFAULT6_DOWN		((JOY_LIST_FIRST + 3) + (JOY_MAX_INPUTS * 5))
#define	CONTROL_DEFAULT6_LEFT		((JOY_LIST_FIRST + 4) + (JOY_MAX_INPUTS * 5))
#define CONTROL_DEFAULT6_FIRE1		((JOY_LIST_FIRST + 5) + (JOY_MAX_INPUTS * 5))
#define CONTROL_DEFAULT6_FIRE2		((JOY_LIST_FIRST + 6) + (JOY_MAX_INPUTS * 5))
#define	CONTROL_DEFAULT6_FIRE3		((JOY_LIST_FIRST + 7) + (JOY_MAX_INPUTS * 5))
#define	CONTROL_DEFAULT6_FIRE4		((JOY_LIST_FIRST + 8) + (JOY_MAX_INPUTS * 5))
#define	CONTROL_DEFAULT6_FIRE5		((JOY_LIST_FIRST + 9) + (JOY_MAX_INPUTS * 5))
#define	CONTROL_DEFAULT6_FIRE6		((JOY_LIST_FIRST + 10) + (JOY_MAX_INPUTS * 5))
#define CONTROL_DEFAULT6_START		((JOY_LIST_FIRST + 11) + (JOY_MAX_INPUTS * 5))
#define CONTROL_DEFAULT6_SCREENSHOT ((JOY_LIST_FIRST + 12) + (JOY_MAX_INPUTS * 5))
#define	CONTROL_DEFAULT6_ESC        ((JOY_LIST_FIRST + 15) + (JOY_MAX_INPUTS * 5))
