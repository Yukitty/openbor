...
#define	CONTROL_DEFAULT5_UP			(1+(16*4))
#define	CONTROL_DEFAULT5_RIGHT		(2+(16*4))
#define	CONTROL_DEFAULT5_DOWN		(3+(16*4))
#define	CONTROL_DEFAULT5_LEFT		(4+(16*4))
#define CONTROL_DEFAULT5_FIRE1		(5+(16*4))
#define CONTROL_DEFAULT5_FIRE2		(6+(16*4))
#define	CONTROL_DEFAULT5_FIRE3		(7+(16*4))
#define	CONTROL_DEFAULT5_FIRE4		(8+(16*4))
#define	CONTROL_DEFAULT5_FIRE5		(13+(16*4))
#define	CONTROL_DEFAULT5_FIRE6		(14+(16*4))
#define CONTROL_DEFAULT5_START		(11+(16*4))
#define CONTROL_DEFAULT5_SCREENSHOT (10+(16*4))

#define	CONTROL_DEFAULT6_UP			(1+(16*5))
#define	CONTROL_DEFAULT6_RIGHT		(2+(16*5))
#define	CONTROL_DEFAULT6_DOWN		(3+(16*5))
#define	CONTROL_DEFAULT6_LEFT		(4+(16*5))
#define CONTROL_DEFAULT6_FIRE1		(5+(16*5))
#define CONTROL_DEFAULT6_FIRE2		(6+(16*5))
#define	CONTROL_DEFAULT6_FIRE3		(7+(16*5))
#define	CONTROL_DEFAULT6_FIRE4		(8+(16*5))
#define	CONTROL_DEFAULT6_FIRE5		(13+(16*5))
#define	CONTROL_DEFAULT6_FIRE6		(14+(16*5))
#define CONTROL_DEFAULT6_START		(11+(16*5))
#define CONTROL_DEFAULT6_SCREENSHOT (10+(16*5))
