...
#define CONTROL_DEFAULT5_FIRE1		(5+(18*4))
#define CONTROL_DEFAULT5_FIRE2		(6+(18*4))
#define	CONTROL_DEFAULT5_FIRE3		(7+(18*4))
#define	CONTROL_DEFAULT5_FIRE4		(8+(18*4))
#define	CONTROL_DEFAULT5_FIRE5		(9+(18*4))
#define	CONTROL_DEFAULT5_FIRE6		(10+(18*4))
...
#define CONTROL_DEFAULT6_FIRE1		(5+(18*5))
#define CONTROL_DEFAULT6_FIRE2		(6+(18*5))
#define	CONTROL_DEFAULT6_FIRE3		(7+(18*5))
#define	CONTROL_DEFAULT6_FIRE4		(8+(18*5))
#define	CONTROL_DEFAULT6_FIRE5		(9+(18*5))
#define	CONTROL_DEFAULT6_FIRE6		(10+(18*5))
