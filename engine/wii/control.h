...
#define	CONTROL_DEFAULT5_UP			(1+(MAX_BUTTONS*4))
#define	CONTROL_DEFAULT5_RIGHT		(2+(MAX_BUTTONS*4))
#define	CONTROL_DEFAULT5_DOWN		(3+(MAX_BUTTONS*4))
#define	CONTROL_DEFAULT5_LEFT		(4+(MAX_BUTTONS*4))
#define CONTROL_DEFAULT5_FIRE1		(5+(MAX_BUTTONS*4))
#define CONTROL_DEFAULT5_FIRE2		(7+(MAX_BUTTONS*4))
#define	CONTROL_DEFAULT5_FIRE3		(16+(MAX_BUTTONS*4))
#define	CONTROL_DEFAULT5_FIRE4		(17+(MAX_BUTTONS*4))
#define	CONTROL_DEFAULT5_FIRE5		(6+(MAX_BUTTONS*4))
#define	CONTROL_DEFAULT5_FIRE6		(8+(MAX_BUTTONS*4))
#define CONTROL_DEFAULT5_START		(10+(MAX_BUTTONS*4))
#define CONTROL_DEFAULT5_SCREENSHOT (9+(MAX_BUTTONS*4))

#define	CONTROL_DEFAULT6_UP			(1+(MAX_BUTTONS*5))
#define	CONTROL_DEFAULT6_RIGHT		(2+(MAX_BUTTONS*5))
#define	CONTROL_DEFAULT6_DOWN		(3+(MAX_BUTTONS*5))
#define	CONTROL_DEFAULT6_LEFT		(4+(MAX_BUTTONS*5))
#define CONTROL_DEFAULT6_FIRE1		(5+(MAX_BUTTONS*5))
#define CONTROL_DEFAULT6_FIRE2		(7+(MAX_BUTTONS*5))
#define	CONTROL_DEFAULT6_FIRE3		(16+(MAX_BUTTONS*5))
#define	CONTROL_DEFAULT6_FIRE4		(17+(MAX_BUTTONS*5))
#define	CONTROL_DEFAULT6_FIRE5		(6+(MAX_BUTTONS*5))
#define	CONTROL_DEFAULT6_FIRE6		(8+(MAX_BUTTONS*5))
#define CONTROL_DEFAULT6_START		(10+(MAX_BUTTONS*5))
#define CONTROL_DEFAULT6_SCREENSHOT (9+(MAX_BUTTONS*5))
